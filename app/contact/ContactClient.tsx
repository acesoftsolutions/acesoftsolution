...
const contactSchema = z.object({
  ...
  company: z
    .string()
    .min(1, 'Please enter your company name or website'),
      ...
      <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl">
          ...
          <p className="mt-6 max-w-4xl text-lg leading-relaxed text-slate-600">
            Share a few details and we will start with a short
            conversation to understand your goals, timelines, and
            expectations before any next steps.
          </p>
        </div>
          ...
          <div className="grid gap-x-12 gap-y-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-8">
              ...
              <label className="flex cursor-pointer items-start gap-2 text-base text-slate-700">
                ...
                I agree to receive marketing updates from Ace
                Soft Solution.
