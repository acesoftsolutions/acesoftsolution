...
const jobs = [
  {
    ...
    description:
      'We are looking for a senior full-stack developer to join our engineering team and help build innovative solutions for our clients.',
    requirements: [
...

  {
    ...
    description:
      "Join our design team to create beautiful and intuitive user interfaces for our clients' digital products.",
    requirements: [
...

  {
    ...
    description:
      'Lead project teams to deliver high-quality digital solutions on time and within budget.',
    requirements: [
...

  {
    ...
    description:
      'Drive our marketing initiatives and help grow our brand presence.',
    requirements: [
          ...
          <div className="container-custom">
            <AnimatedSection className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-muted text-lg">
                ...
                join our growing team. Explore our open positions and
