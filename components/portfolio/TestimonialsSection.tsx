...
return ( <section className="relative overflow-hidden bg-slate-50 py-24 lg:py-32">
  ...
  <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
    ...
    >
      ...
      <p className="mt-6 text-lg text-slate-600">
        ...
        Ace Soft Solution and the impact our digital
        solutions have created for their organizations.
      </p>
    </motion.div>
